...
The personal low-cost deployment deliberately ships a smaller profile:
...
- PDF compilation is an opt-in slice using Cloud Tasks, a private scale-to-zero
  compiler service, and private Cloud Storage;
- AI CV generation remains disabled.
